...
class AIAnalysisHandler(BaseHTTPRequestHandler):
    ...
    def _handle_analyze(self):
        ...
        try:
            ...
            self._send_error_response(500, "Sports analysis failed", {
    ...
    def _handle_recommend_drills(self):
        ...
        try:
            ...
            logger.error(f"Drill recommendation failed: {str(e)}")
            self._send_error_response(500, "Drill recommendation failed", {
                "error_type": "DRILL_RECOMMENDATION_ERROR",
                "details": str(e),
                "endpoint": "/recommend_drills"
            })
    ...
    def _handle_generate_report(self):
        ...
        try:
            ...
            self._send_error_response(500, "Report generation failed", {
    ...
    def _send_error_response(self, code, message, error_details=None):
        """Send enhanced error response with context"""
