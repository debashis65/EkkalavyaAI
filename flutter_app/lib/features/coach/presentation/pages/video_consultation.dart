...
class _VideoConsultationState extends ConsumerState<VideoConsultation> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavbar(currentRoute: '/coach/video-consultation'),
    );
  }
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: const Icon(Icons.video_call, size: 16),
            ),
          ),
        ],
      ),
          ...
          ElevatedButton(
            onPressed: () {
              ...
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  title: const Text('Real-time Analysis'),
                  content: const Text('Real-time biomechanical analysis is now active. AI will provide live feedback on technique and performance.'),
                  actions: [
                    TextButton(
                      onPressed: () => Navigator.of(context).pop(),
  ...
  void _startVideoCall(Map<String, dynamic> session) {
    setState(() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Starting video session with ${session['studentName']}...'),
        backgroundColor: AppTheme.primaryGreen,
      ),
    );
  }
  ...
  void _endVideoCall() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Video session ended'),
  ...
  void _toggleMute() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: _isMuted ? Colors.red : AppTheme.primaryGreen,
      ),
    );
  }
  ...
  void _toggleVideo() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(_isVideoOff ? 'Video turned off' : 'Video turned on'),
        backgroundColor: _isVideoOff ? Colors.red : AppTheme.primaryGreen,
      ),
    );
  }
  ...
  void _shareScreen() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Screen sharing initiated'),
  ...
  void _startRecording() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Session recording started'),
        backgroundColor: AppTheme.primaryOrange,
      ),
    );
  }

  void _showFormAnalysis() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('AI analyzing student\'s form...'),
            SizedBox(height: 16),
            LinearProgressIndicator(),
            SizedBox(height: 16),
            Text('Results will appear in real-time during the session'),
          ],
        ),
        actions: [
          TextButton(
        ...
        content: const Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text('Reaction Time: 0.8s'),
              dense: true,
            ),
            ListTile(
              leading: Icon(Icons.straighten, color: AppTheme.primaryBlue),
              title: Text('Form Score: 87/100'),
              dense: true,
            ),
            ListTile(
              leading: Icon(Icons.fitness_center, color: AppTheme.primaryOrange),
              title: Text('Power Output: 92%'),
              dense: true,
            ),
          ],
        ),
