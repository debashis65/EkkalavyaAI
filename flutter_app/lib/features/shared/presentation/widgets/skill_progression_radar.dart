                    ...
                    dataSets: [
                      ...
                      RadarDataSet(
                        ...
                        dataEntries: skills.map((skill) => 
                          RadarEntry(value: (skill['previous'] as int).toDouble() * _animation.value)
                        ).toList(),
                      ),
                      ...
                      RadarDataSet(
                        ...
                        borderWidth: 2,
                        dataEntries: skills.map((skill) => 
                          RadarEntry(value: (skill['target'] as int).toDouble() * _animation.value)
                        ).toList(),
                      ),
                      ...
                      RadarDataSet(
                        ...
                        borderWidth: 3,
                        dataEntries: skills.map((skill) => 
                          RadarEntry(value: (skill['current'] as int).toDouble() * _animation.value)
                        ).toList(),
                      ),
                    ],
