        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8 md:mb-12">
            <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <Target className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-blue-600" />
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">AI Analysis Tools</h1>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6 mb-6 sm:mb-8 md:mb-12">
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center">
                <Zap className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-yellow-500 mx-auto mb-3 sm:mb-4" />
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Real-time Analysis</h3>
                <p className="text-sm sm:text-base text-gray-600">Instant feedback on your technique</p>
              </CardContent>
            </Card>
            
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center">
                <BarChart3 className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-green-500 mx-auto mb-3 sm:mb-4" />
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Performance Metrics</h3>
                <p className="text-sm sm:text-base text-gray-600">Detailed biomechanical scoring</p>
              </CardContent>
            </Card>
            
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center">
                <Trophy className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-purple-500 mx-auto mb-3 sm:mb-4" />
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Progress Tracking</h3>
                <p className="text-sm sm:text-base text-gray-600">Monitor improvement over time</p>
              </CardContent>
            </Card>
          </div>

          {/* Sport Selection - Mobile First */}
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <Button
              variant={selectedSport === "basketball" ? "default" : "outline"}
              onClick={() => setSelectedSport("basketball")}
              className="flex items-center justify-center gap-2 w-full sm:w-auto text-sm sm:text-base py-2.5 sm:py-2"
            >
              🏀 Basketball
            </Button>
            <Button
