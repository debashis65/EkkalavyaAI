...
export default function RegisterImproved() {
  ...
  return (
    <>
      <Helmet>
        <title>Register | Ekalavya</title>
        <meta
          name="description"
          content="Create an account on Ekalavya to connect with expert coaches and start your sports training journey."
        />
      </Helmet>
        ...
        <Card className="w-full max-w-md shadow-lg border-muted">
          <CardHeader className="pb-4">
            ...
            <p className="text-muted-foreground text-center text-sm mt-1">
              Join Ekalavya to connect with expert coaches and improve your skills
            </p>
          </CardHeader>
          <CardContent>
            <Form {...form}>
