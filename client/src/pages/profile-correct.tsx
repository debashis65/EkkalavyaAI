  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-accent rounded-t-lg p-3 sm:p-4 md:p-6 text-white relative">
        ...
        <Tabs defaultValue="performance" className="bg-white rounded-b-lg shadow-sm">
          ...
          <TabsContent value="performance" className="p-3 sm:p-4 md:p-6">
          ...
          <TabsContent value="training" className="p-3 sm:p-4 md:p-6">
          ...
          <TabsContent value="videos" className="p-3 sm:p-4 md:p-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <Card>
                <CardHeader>
          ...
          <TabsContent value="reports" className="p-3 sm:p-4 md:p-6">
            <div className="space-y-6">
              <Card>
                <CardHeader>
