...
function PlayerDashboard() {
  ...
  return (
    <>
      {/* Player Header - Mobile-first responsive */}
      <div className="bg-primary px-4 sm:px-6 py-4 sm:py-6 text-primary-foreground">
        <h1 className="text-xl sm:text-2xl font-semibold mb-1">Welcome back, {user?.name}</h1>
        <p className="text-sm sm:text-base text-primary-foreground/80">Continue your learning journey today</p>
      </div>
      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <Card className="p-3 sm:p-4 hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex flex-col items-center text-center space-y-1 sm:space-y-2">
              <div className="p-2 sm:p-3 bg-green-100 dark:bg-green-900 rounded-full">
                <Search className="h-4 w-4 sm:h-6 sm:w-6 text-green-600 dark:text-green-400" />
              </div>
              <span className="text-sm sm:text-base font-medium">Find Mentor</span>
            </div>
          </Card>
          ...
          <Card className="p-3 sm:p-4 hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex flex-col items-center text-center space-y-1 sm:space-y-2">
              <div className="p-2 sm:p-3 bg-blue-100 dark:bg-blue-900 rounded-full">
                <Upload className="h-4 w-4 sm:h-6 sm:w-6 text-blue-600 dark:text-blue-400" />
              </div>
              <span className="text-sm sm:text-base font-medium">Upload Practice</span>
            </div>
          </Card>
          ...
          <Card className="p-3 sm:p-4 hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex flex-col items-center text-center space-y-1 sm:space-y-2">
              <div className="p-2 sm:p-3 bg-purple-100 dark:bg-purple-900 rounded-full">
                <Video className="h-4 w-4 sm:h-6 sm:w-6 text-purple-600 dark:text-purple-400" />
              </div>
              <span className="text-sm sm:text-base font-medium">Live Sessions</span>
            </div>
          </Card>
          ...
          <Card className="p-3 sm:p-4 hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex flex-col items-center text-center space-y-1 sm:space-y-2">
              ...
              <span className="text-sm sm:text-base font-medium">Achievements</span>
            </div>
          </Card>
        </div>
        ...
        {/* Performance Stats Grid - Mobile-first responsive */}
...
function CoachDashboard() {
  ...
  return (
    <>
      {/* Coach Header - Mobile-first responsive */}
      <div className="bg-primary px-4 sm:px-6 py-4 sm:py-6 text-primary-foreground">
        <h1 className="text-xl sm:text-2xl font-semibold mb-1">Coach Dashboard</h1>
        <p className="text-sm sm:text-base text-primary-foreground/80">Manage your students and track their progress</p>
      </div>

      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        {/* Monthly Earnings & Active Students - Mobile-first grid */}
        ...
        <Card>
          ...
          <CardContent className="space-y-3 sm:space-y-4">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 sm:p-4 border rounded-lg space-y-2 sm:space-y-0">
              <div className="flex-1">
                <h4 className="font-semibold">Basic Archery</h4>
                <p className="text-xs sm:text-sm text-muted-foreground">4 lessons per month • Video reviews • Chat support</p>
                <p className="text-xs sm:text-sm text-green-600 mt-1">35 students enrolled</p>
              </div>
              <div className="flex justify-between sm:block sm:text-right">
                <p className="font-bold">₹4,500/mo</p>
                <Badge className="sm:mt-1">Most Popular</Badge>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center p-3 sm:p-4 border rounded-lg space-y-2 sm:space-y-0">
              <div className="flex-1">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground">8 lessons per month • One-on-one coaching • 24/7 support</p>
                <p className="text-xs sm:text-sm text-green-600 mt-1">13 students enrolled</p>
              </div>
              <div className="flex justify-between sm:block sm:text-right">
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="p-3 sm:p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm text-muted-foreground">Response</p>
            ...
            <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-gray-50 dark:bg-gray-950 rounded-lg">
              <p className="text-xs sm:text-sm text-muted-foreground mb-2">Student Satisfaction</p>
              <div className="h-2 sm:h-3 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                <div className="h-full bg-green-500 rounded-full" style={{ width: '92%' }}></div>
              </div>
              <p className="text-xs sm:text-sm font-medium mt-1">92%</p>
            </div>
          </CardContent>
        </Card>
      </div>
