...
export default function CoachDashboard({ user }: CoachDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white py-6 sm:py-8 text-center px-4 sm:px-6">
        ...
        <Button className="bg-orange-500 hover:bg-orange-600 text-white px-6 sm:px-8 w-full sm:w-auto">
          Book Session
        </Button>
      </div>
      ...
      <div className="border-b bg-white">
        <div className="flex gap-4 sm:gap-8 px-4 sm:px-6 overflow-x-auto">
          <button className="py-3 border-b-2 border-blue-500 text-blue-600 font-medium text-sm sm:text-base whitespace-nowrap">
            Overview
          </button>
          <button className="py-3 text-gray-600 hover:text-gray-800 text-sm sm:text-base whitespace-nowrap">
            Schedule
          </button>
          <button className="py-3 text-gray-600 hover:text-gray-800 text-sm sm:text-base whitespace-nowrap">
            Athletes
